...
def harmonicDetection(pfreq, pmag, pphase, f0, nH, hfreqp, fs, devRatio = 3.0, harmDevSlope=0.01):
	"""
	...
	th1: the first part of threshold, defaut f0/3
	...
	while (f0>0) and (hi<nH) and (hf[hi]<fs/2):          # find harmonic peaks
		...
		threshold = f0/devRatio + harmDevSlope * pfreq[pei]
